...
class Register(models.Model):
    ...
    c_professor_name=models.CharField(max_length=20,blank=True,null=True)
    ...
    c_contact = models.CharField(validators=[phone_regex], blank=True,max_length=15) 
...
class project_desc(models.Model):
    ...
    c_branch = models.CharField(max_length=10, choices=BRANCH, default='CS')  
    c_course = models.CharField(max_length=5, choices=COURSE, default='BTECH') 
    def __str__(self):
